    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <nav>
                ...
                <ul>
                    <li>
                        <img src="../assets/image/menu01.png">
                        <div class="nav-item-text" @click="todeepseek">
                            <h3>免费咨询</h3>
                            <p>新型冠状病毒肺炎</p>
                        </div>
                    </li>
                    <li>
                        <img src="../assets/image/menu02.png">
                    ...
                    <li>
                        <img src="../assets/image/menu03.png">
                        <div class="nav-item-text">
                    ...
                    <li>
                        <img src="../assets/image/menu04.png">
                        <div class="nav-item-text">
                            <h3>慢病管理</h3>
                            <p>血压血糖健康管理</p>
                        </div>
                    ...
                    <li>
                        <img src="../assets/image/menu05.png">
                        <div class="nav-item-text">
                            <h3>上门护理</h3>
                            <p>网上购买上门服务</p>
                        </div>
                    ...
                    <li @click="appointment">
                        <img src="../assets/image/menu06.png">
                        <div class="nav-item-text">
                            <h3>团检预约</h3>
                            <p>团体体检套餐定制</p>
                        </div>
            ...
            <div class="doctor">
                ...
                <ul>
                    <li>
                        <img src="../assets/image/doctor1.jpg">
                        <h3>刘长胜</h3>
                        <p>主任医师</p>
                    </li>
                    <li>
                        <img src="../assets/image/doctor2.jpg">
                        <h3>孙鹿</h3>
                        <p>主任医师</p>
                    </li>
                    <li>
                        <img src="../assets/image/doctor3.jpg">
                        <h3>吕文达</h3>
                        <p>主任医师</p>
                    </li>
                    <li>
                        <img src="../assets/image/doctor4.jpg">
                        <h3>李若辰</h3>
                        <p>主任医师</p>
                    </li>
                    <li>
                        <img src="../assets/image/doctor5.jpg">
                        <h3>张石凡</h3>
                        <p>主任医师</p>
                    </li>
                    <li>
                        <img src="../assets/image/doctor6.jpg">
                        <h3>赵桂凤</h3>
                        <p>副主任医师</p>
                    </li>
                    <li>
                        <img src="../assets/image/doctor7.jpg">
                        <h3>李文</h3>
                        <p>主任医师</p>
                    </li>
                    <li>
                        <img src="../assets/image/doctor8.jpg">
                        <h3>吴晓梦</h3>
                        <p>主任医师</p>
                    </li>
                </ul>
            ...
            <div class="assess">
                ...
                <div class="assess-content">
                    <div class="scroll-box" id="scrollBox">
                        <ul id="scrollBar">
                            <li><img src="../assets/image/assess1.png"></li>
                            <li><img src="../assets/image/assess2.png"></li>
                            <li><img src="../assets/image/assess3.png"></li>
                            <li><img src="../assets/image/assess4.png"></li>
                            <li><img src="../assets/image/assess5.png"></li>
                            <li><img src="../assets/image/assess6.png"></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="info">
                ...
                <ul>
                    <li>
                        <img src="../assets/image/info1.png">
                        <div>
                    ...
                    <li>
                        <img src="../assets/image/info2.png">
                        <div>
                            <h3>体检发现甲状腺结节，怎么办？</h3>
                            <span>日常需注意什么？</span>
...
export default {
    setup() {
        ...
        test()
        function test(){
            let user = getSessionStorage("users")
            console.log(user)
        }
        function todeepseek(){
