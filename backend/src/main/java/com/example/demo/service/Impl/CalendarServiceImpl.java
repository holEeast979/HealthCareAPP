...
public class CalendarServiceImpl implements CalendarService {
    ...
    private List<CalendarResponseDto> getCalendarList30(Integer hpid){
        ...
        String[] strArr = hospitalMapper.selectByPrimaryKey(hpid).getRule().split(",");  //0,200,200,200,200,200,100
    ...
    //获取当前年和当前月的日历  返回几年几月的万年历   大概30天数据+占位
    @Override
